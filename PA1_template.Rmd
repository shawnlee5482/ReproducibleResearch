...
```{r, echo=TRUE}
qplot(Date, Mean.steps.per.day, data=stat_per_day, geom="line", xlab="Date", ylab="Average number of steps taken")
...
ave_steps_per_day <- aggregate(steps~interval+weekend, data=activity, FUN=ave)

qplot(interval, steps, data=activity, geom="line", facets = .~weekend)
